<x-guest-layout>
    <div class="flex pt-5">
        <div class="pl-[100px] pb-[50px]">
            <h1 class="bg-[#2b364d] max-w-[400px] p-5 font-bold text-3xl rounded-t-3xl">Wie ben ik</h1>
        ...
        <div class="flex ml-auto mr-[100px] bg-[#2b364d] mb-[50px] rounded-3xl p-5 max-w-[500px]">
            <form class="flex flex-wrap" action="{{ route('contact.create') }}" method="post">
                ...
                <div class="w-4/5">
                    <input class="w-full rounded-xl text-black" type="text" name="name" value="{{ old('name') }}">
                </div>
                @error('name')
                {{$message}}
                @enderror
                ...
                <div class="w-4/5">
                    <input class="w-full rounded-xl text-black" type="text" name="email" value="{{ old('email') }}">
                </div>
                @error('email')
                {{$message}}
                @enderror
                ...
                <div class="w-4/5">
                    <textarea class="w-full rounded-xl h-24 text-black" name="message">{{ old('message') }}</textarea>
                </div>
                @error('message')
                {{$message}}
                @enderror
